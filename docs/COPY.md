...
Every piece of text on the public website, page by page, as it appears today.

How to mark it up: delete a line to remove it, edit a line to change it, write `KEEP` or nothing to leave it. Add a note under any line if you want something different. Then send the file back.

Labels in front of each line say what kind of element it is (H1 = main heading, Link, Button, Field label, Placeholder = grey hint text inside a box). Do not edit the labels.

The eight "Landing page" sections are the Google-only local pages. They are not linked from the site; people reach them from search results.
...
- Text: About 8 by 10 feet with a plain wall or room for a background, and an outlet. A conference room works. I bring everything else.
- Term: Can everyone on the team have the same background?
...
- Text: Yes, free parking at the building. Directions and parking notes are in your confirmation email.
- Term: I need a photo for a passport or visa too. Can you do that in the same session?
...
- Link: Headshots in Nanuet
- Link: Headshots in Ramapo
- Link: Headshots in Rockland County


## Landing page: Monsey  (`/headshots/monsey`)
...
## Landing page: Nanuet  (`/headshots/nanuet`)
...
- Text: Yes. West Nyack, Nanuet, Bardonia and all of Clarkstown are within the county, so there is no travel fee.
- Term: Can you match photos we already have?
...
## Landing page: New City  (`/headshots/new-city`)
...
- Text: Tell me the requirements when you book and the files are delivered in that size in addition to the standard web and print versions.
- Term: Is retouching included?
...
## Landing page: Airmont  (`/headshots/airmont`)
...
- Text: Yes, Sunday through Thursday evenings on request. Say the time that works in the form.
- Term: Do you photograph in Mahwah or elsewhere in Bergen County, NJ?
...
## Landing page: Suffern  (`/headshots/suffern`)
...
- Text: Both, if you like. Many practices want one of each; it adds about two minutes per person.
- Term: We are in Mahwah, just over the line. Do you come there?
...
## Landing page: Ramapo  (`/headshots/ramapo`)
...
- Text: Yes. A staff of 40 takes about a school day with one setup. Larger staffs are split over two days or two setups.
- Term: How do I book?
...
- Error: This gallery is not available.

## Client gallery: photos  (`/g/<gallery-name>`, after the code)
...
- Text: Headshot Photography · Rockland County, NY
- Text: Meilech Biller
- Text: Professional headshots in Rockland County, NY.
